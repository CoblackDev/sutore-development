...
/**
 * Staff merchants shell. List and detail bodies load via REST.
 *
 * @var array{
 *   detail_id: int,
 *   search: string,
...
?>
<div class="sutore-mp sutore-mp-account-panel sutore-mp-staff-manage sutore-mp-staff-merchants">
    <?php if ($detailId > 0) : ?>
        <div class="sutore-mp-listings-header sutore-mp-detail-chrome" hidden>
            <h2 class="sutore-mp-staff-detail-title"></h2>
            <div class="sutore-mp-header-actions">
                <a class="wp-element-button is-style-outline" href="<?php echo esc_url($baseUrl); ?>">
                    &larr; <?php esc_html_e('Back to list', 'sutore-marketplace'); ?>
                </a>
            </div>
        </div>

        <div
            class="sutore-mp-staff-merchants-detail-root"
            data-merchant-id="<?php echo esc_attr((string) $detailId); ?>"
