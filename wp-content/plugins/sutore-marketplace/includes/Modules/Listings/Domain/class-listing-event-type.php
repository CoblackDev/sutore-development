...
final class ListingEventType
{
    ...
    public static function label(string $eventType): string
    {
        return match ($eventType) {
            'listing_created' => __('Product created', 'sutore-marketplace'),
            'listing_status_changed' => __('Product status changed', 'sutore-marketplace'),
            ...
            'listing_duration_changed' => __('Sale duration changed', 'sutore-marketplace'),
            'listing_put_on_sale' => __('Put on sale', 'sutore-marketplace'),
            'listing_removed_from_sale' => __('Removed from sale', 'sutore-marketplace'),
            'listing_deleted' => __('Product deleted', 'sutore-marketplace'),
            'listing_expired' => __('Product expired', 'sutore-marketplace'),
            ...
            'order_listing_swapped' => __('Product swapped on order', 'sutore-marketplace'),
            ...
            'listing_approved' => __('Product approved', 'sutore-marketplace'),
            ...
            'sourcing_listing_auto_created' => __('Product auto-created for pre-order', 'sutore-marketplace'),
            ...
            'outlet_listing_created' => __('Outlet product created', 'sutore-marketplace'),
            'listing_bulk_import' => __('Bulk import completed', 'sutore-marketplace'),
            'listing_lifecycle_completed' => __('Product lifecycle completed', 'sutore-marketplace'),
            'fulfillment_payment' => __('Sale: payment pending', 'sutore-marketplace'),
            'fulfillment_payment_confirmed' => __('Sale: payment confirmed', 'sutore-marketplace'),
            ...
            'listing_commission_set' => __('Product commission set', 'sutore-marketplace'),
